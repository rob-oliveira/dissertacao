...
\label{cap:introducao}
    ...
    %A abordagem que propomos enxerga um sistema \acrshort{ami} como um sistema multiagente, onde cada componente do sistema pode ser representados por um ou mais agentes inteligentes. Nossa intenção é simular o comportamento que esperamos dos usuários, do \textit{hardware}, e do software do sistema, estudando a forma como se relacionam a partir das informações que temos do ambiente e, daquilo que presumimos que o usuário deseja.
